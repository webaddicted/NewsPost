...
import com.example.myapplication.databinding.ItemNewsOfferBinding
import com.example.myapplication.model.bean.SearchRespo
import com.example.myapplication.view.base.BaseAdapter

class NewsOfferAdapter(private var dataList: ArrayList<SearchRespo.Photos.Photo>?) : BaseAdapter() {
...
//        return dataList?.size
    ...
    override fun getLayoutId(viewType: Int): Int {
        return R.layout.item_news_offer
    }

    override fun onBindTo(rowBinding: ViewDataBinding, position: Int) {
        if (rowBinding is ItemNewsOfferBinding) {
